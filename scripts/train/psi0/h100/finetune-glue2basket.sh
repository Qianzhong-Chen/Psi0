...
# Dataset: hojjunekim/humanoid_glue2basket_teleop_18act_eef_psi (HF Hub)
#   Place at: $HF_LEROBOT_HOME/hojjunekim/humanoid_glue2basket_teleop_18act_eef_psi/
...
export task="${1:-hojjunekim/humanoid_glue2basket_teleop_18act_eef_psi}"
