...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/teleop_turn_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "teleop_turn_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_locomani_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_locomani_align_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_locomani_align_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_locomani_adjust_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_locomani_adjust_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_locomani_adjust_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_locomani_camfix_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_locomani_camfix_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_locomani_camfix_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_locomani_camfix50_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_locomani_camfix50_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_locomani_camfix50_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_turn_adjust_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_turn_adjust_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_turn_adjust_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_turn_camfix_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_turn_camfix_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_turn_camfix_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_turn_camfix50_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_turn_camfix50_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_turn_camfix50_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_turn_pure_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_turn_pure_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_turn_pure_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_turn_pure50_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_turn_pure50_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_turn_pure50_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="sam_turn_pure_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/sam_turn_pure_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "sam_turn_pure_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="wigs_turn_fast_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/wigs_turn_fast_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "wigs_turn_fast_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="sam_locomani_adjust_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/sam_locomani_adjust_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "sam_locomani_adjust_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
    TrainConfig(
        name="sam_turn_camfix_pi05",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotUniversalDataConfig(
            repo_id=f"{os.environ['HF_LEROBOT_HOME']}/hojjunekim/sam_turn_camfix_uni",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "sam_turn_camfix_uni"},
        checkpoint_base_dir=".runs/openpi-05",
    ),
